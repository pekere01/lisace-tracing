...
const NAV_ITEMS = [
  ...
  { href: "/uyarilar", label: "Lisans Yenileme", icon: RefreshCcw },
...
export function AppSidebar({
  ...
  const navItems =
    user.role === "admin"
      ? [...NAV_ITEMS, { href: "/kullanicilar", label: "Kullanıcılar", icon: Users }]
      : NAV_ITEMS;
      ...
      <SidebarHeader>
        <div className="flex items-center gap-2 px-2 py-1.5">
          ...
          <div className="flex flex-col leading-none group-data-[collapsible=icon]:hidden">
            <span className="font-semibold text-sm">Lisans Paneli</span>
            ...
            <SidebarMenu>
              {navItems.map((item) => (
                <SidebarMenuItem key={item.href}>
                  ...
                  {item.href === "/uyarilar" && renewalAlertsCount > 0 && (
